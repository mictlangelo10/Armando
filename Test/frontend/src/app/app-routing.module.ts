...
const routes: Routes = [
  ...
  //Cliente
  {
    ...
    data: { expectedRoles: ['admin', 'user', 'instructor'] },
  },
  {
    path: 'cliente/nuevo',
  ...
  //Clases
  {
    ...
    canActivate: [ClientesGuard, HomeGuard],
    data: {
      expectedRoles: ['admin', 'user', 'instructor', 'recepcionista'],
    },
  },
  {
  ...
  //proveedor
  {
    ...
    canActivate: [ClientesGuard, HomeGuard],
    data: {
      expectedRoles: ['admin', 'recepcionista'],
    },
  },
  {
  ...
  //Producto
  {
    ...
    canActivate: [ClientesGuard, HomeGuard],
    data: {
      expectedRoles: ['admin', 'user', 'recepcionista'],
    },
  },
  {
  ...
  //CheckIn
  {
    ...
    canActivate: [ClientesGuard, HomeGuard],
    data: {
      expectedRoles: ['admin', 'instructor', 'recepcionista'],
    },
  },
  {
  ...
  //Venta
  {
    ...
    canActivate: [ClientesGuard, HomeGuard],
    data: { expectedRoles: ['admin', 'recepcionista'] },
  },
  {
    path: 'listaVentas',
