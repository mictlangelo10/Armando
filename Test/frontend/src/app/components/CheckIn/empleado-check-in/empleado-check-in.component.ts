        ...
        this.pla.forEach((element: CheckIn) => {
          if (element.tipo === 'Entrance') {
            ...
            if (totalMinutes1 > totalMinutes2) {
              element.estado = 'Delay';
            } else {
              element.estado = 'Attendance';
            }
            console.log('New: ');
            this.r = element;
            console.log(this.r);
