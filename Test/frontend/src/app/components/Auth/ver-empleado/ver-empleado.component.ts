...
export class VerEmpleadoComponent implements OnInit {
  ...
  deleteEmployee(employee: any) {
    ...
    Swal.fire({
      title: 'Do you want to delete the employee?', //+this.selectedRole.Name,//Are you sure?
      text: 'This action cannot be undone.', //+this.selectedRole.Name,
      html: '<p><strong>Employee: </strong>' + employee.username + '</p>',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        Swal.fire({
          title: 'Done!',
          text: 'You have deleted employee ' + employee.username,
          icon: 'success',
